...
class CommonWidgets {
  ...
  static BoxDecoration kGradientBoxDecoration(
      {double? borderRadius, bool showGradientBorder = false}) {
      ...
      child: inAsyncCall
          ? Stack(
              ...
              children: [
                ...
                appIcons(
                    assetName: IconConstants.icDiamond,
                    width: 25.px,
                    height: 25.px,
                    fit: BoxFit.fill)
              ],
  ...
  static Widget commonTextFieldForLoginSignUP(
    ...
    return Container(
      decoration: kGradientBoxDecoration(
          borderRadius: borderRadius, showGradientBorder: isCard),
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              Flexible(
                child: Padding(
                  padding: EdgeInsets.only(left: 3.px, top: 9.px, right: 3.px),
                  child: TextFormField(
                    focusNode: focusNode,
  ...
  static ScaffoldFeatureController<SnackBar, SnackBarClosedReason> snackBarView(
    ...
    var snackBar = SnackBar(
      ...
      backgroundColor:
          success ? Colors.green : Theme.of(Get.context!).errorColor,
    );
